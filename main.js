//decalre variables  rightWristY, rightWristX, scoreRightWrist
rightwristX=0
rightWristY=0
scoreRightWrist=0
...
function preload() {
  //ball_touch_paddel  load sound here
...
function modeLoaded(){
  ...
  console.log("Congratulations. We are proud. the model loaded and you didnt even help. have a taco.")
}
...
function startGame()
{
  ...
  document.getElementById("status").innerHTML="gamezlosdeded"
}
